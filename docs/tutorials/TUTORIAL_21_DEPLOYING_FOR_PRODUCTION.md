...
In simple terms, if you consider GitHub hosting the GitHub Pages site for this repo at the URL `https://github.com/guesmi-rania/Tech-Portfolio`, the correct base directory to set is `/react-portfolio-template/`.
